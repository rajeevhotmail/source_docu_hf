...
summarization_pipeline = pipeline("summarization",
                                  model="mrm8488/bert2bert_shared-finetuned-summarization",
                                  tokenizer="mrm8488/bert2bert_shared-finetuned-summarization")

def summarize_code(code, max_length=300, min_length=100):
    result = summarization_pipeline([code], max_length=max_length, min_length=min_length)
