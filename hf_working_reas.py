...
# Initialize the pipeline with a new accessible model
...
def summarize_function(name, func_code, max_length=100, min_length=50):
    """Generates a summary for a single function."""
    prompt = f"Summarize the purpose of the following Python function named {name}:\n{func_code}\n\nThe summary should explain what the function does, its arguments, and its return value."
